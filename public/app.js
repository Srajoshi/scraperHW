...
$.getJSON("/notes", function (data) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        var deleteNoteBtn = $("<button>").addClass("btn btn-info add-note modal-trigger");
        deleteNoteBtn.attr("data-id", artId)
        // addNoteBtn.attr("data-target", "#notes");
        // addNoteBtn.attr("data-toggle", "modal")
        addNoteBtn.text("Delete Comment")
        divCard.append(addNoteBtn);
